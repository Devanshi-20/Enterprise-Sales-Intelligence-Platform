...
## Key stakeholders
- Sales Manager — KPI visibility, territory performance
- Finance Analyst — Revenue reporting, margin analysis
...
> Full BRD: [BRD_Enterprise_Sales_Intelligence_Platform.docx](.docs/BRD_Enterprise_Sales_Intelligence_Platform_v1.1.docx)
